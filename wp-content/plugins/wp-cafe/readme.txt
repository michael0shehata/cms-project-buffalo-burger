...
== Description ==
WPCafe is a **simple restaurant Menu**, **Online Ordering** for [WooCommerce](https://wordpress.org/plugins/woocommerce/), Pickup / Delivery system to create [Elementor](https://wordpress.org/plugins/elementor/) (food menu)[https://themewinter.com/wp-cafe/], **Restaurant reservation** and **Table Reservation** Plugin. It’s a full fledged solution for your **restaurant**. Be it online or offline restaurant/cafe, you can manage any **food** ordering business with WPCafe.
...
WPCafe is a complete [Restaurant Solution Plugin](https://themewinter.com/wp-cafe/) to run your online Restaurant Business, Online Food Order, Reservation System, Pickup, Delivery, Menu, and more. It has all the features you need to manage your restaurant website and customers. You can keep track of your sales and customers with WPCafe.

With the **simple restaurant menu plugin**, you can also create online food ordering, **food listing**, **food online premium** and other **food presentation** websites with WPCafe **Food Ordering Plugin**.
...
WPCafe offers over 33+ food menus for you to choose from. You can create **lunch** menu, **dinner menu**, special day [menu](https://product.themewinter.com/wpcafe/menu-list/), special menu of the day, category based food menu, **cafe menu**, and a lot more great styles for a beautiful **Food presentation**! 
...
By using WPCafe, you will never miss an order. With the **live order notification** & tipping feature, every time a customer places an order, you will be instantly notified. 
...
With this Visual Table Reservation system, **restaurant booking** will be a hassle-free experience for your customers and for yourself. 
...
To know how to set up the [visual table reservation](https://support.themewinter.com/docs/plugins/plugin-docs/reservation/table-selection-layout/) feature and use the visual table reservation feature, you can read our documentation.
...
With WPCafe you also have the option to add a **minicart** to your food ordering website. Your customers can add their preferred food into this virtual cart. After choosing their preferred food, customers can then check out food items from the minicart. 
...
Special days require special menus. Give your customers a reason to make their day special by crafting a special menu with WPCafe. You can even add a special discount on the special menu.
...
##Loyalty Program Points & Rewards for Food Ordering##
